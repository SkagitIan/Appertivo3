...
urlpatterns = [
    ...
    path("dishes/<uuid:concept_id>/view-mode/", app_views.dish_view_mode_update, name="dish-view-mode"),
    ...
    path("favorites/view-mode/", app_views.favorites_view_mode_update, name="favorites-view-mode"),
    path("menus/", app_views.menus_view, name="menus"),
    path("menus/view-mode/", app_views.menus_view_mode_update, name="menus-view-mode"),
